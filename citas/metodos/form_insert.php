<form action="metodos/insert.php" method="post">
    ...
    <div class="form-group">
        ...
        <select class="custom-select" id="servicio" name="servicio" required>
            ...
            <option value="Agendar Mantencion">Agendar Mantencion</option>
            <option value="Agendar cita para reparaciones">Agendar cita para reparaciones</option>
            <option value="Cita con Gerente">Cita con Gerente</option>
        </select>
    </div>
